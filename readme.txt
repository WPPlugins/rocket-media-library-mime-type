...
3-1. 네이버 번역 API 를 이용해 한글 파일명을 자동으로 영문으로 전환할 수 있습니다.(하루에 10000 글자 제한이 있습니다.) 예를들어 파일명이 "오렌지.jpg" 라면  "orange.jpg" 로 자동 번역되어 업로드 됩니다.
...
문의사항 및 요청, 버그 리포트 등은 http://rocketpress.kr/forum/ 에 댓글이나 메일을 보내주세요.
...
5. 한글 파일명을 영문으로 자동 변환 기능을 활성화 한 후 "미디어 라이브러리.jpg"라는 이름의 한글 파일을 업로드해서 영문 "051ede1675ed54e78d.jpg" 로 자동 변환한 모습입니다.
