	...
	<div class="rocket-wrap">
		...
		<form action="#" method="post" id="rocketfont_form" role="form">
			...
			<table class="">
				<tbody>
					<tr>
						<th width="80%">파일 업로드시 한글 파일명을 자동으로 영문으로 변환 <i class="fa fa-question-circle fa-c2x tooltips" title="파일명이 한글이면 몇가지 오류가 발생할 수 있습니다.<br>1. 업로드 후 파일명이 깨진다거나<br>2.경로명은 맞는데 이미지가 보이지 않는다거나<br>3.예를들어 PDF 파일을 사용함으로 설정했는데도 업로드가 안된다거나<br><br>위와같은 현상이 있거나 방지하고 싶다면 이 옵션을 사용하면 됩니다."></i></th>
						<td>
					...
					<tr class="file-translate-options">
						<th width="80%">변환된 파일명에 업로드 일시를 붙임<i class="fa fa-question-circle fa-c2x tooltips" title="이 옵션을 사용하면 한글에서 영문으로 변환된 파일명 뒤에 자동으로 업로드한 시각 및 영문으로 변환한 후 업로드합니다.<br>워드프레스는 업로드한 폴더를 년월로 나눠서 관리하는데,<br>한달에 업로드하는 파일의 양이 많아 파일명만 보고도 알 언제 업로드한 파일인지 알고 싶을경우 사용하면 됩니다."></i></th>
						<td>
							<div class="switch round">
					...
					<tr class="file-translate-options">
						<th width="80%">한글 파일을 영문으로 변환시 네이버 번역 API를 이용해 변환<i class="fa fa-question-circle fa-c2x tooltips" title="이 옵션을 사용하면 네이버의 번역 API를 이용해 한글 파일명을 영문으로 번역합니다. <br>아래의 네이버의 Client ID 와 Client Secret 입력이 필요합니다."></i></th>
						<td>
							<div class="switch round">
					...
					<tr class="file-translate-options naver-translate-options">
						<th width="80%">네이버 API - Client ID <i class="fa fa-question-circle fa-c2x tooltips" title="<a href='https://developers.naver.com/register' target='_blank'>이곳</a>에서 신청하면 됩니다. <br>키를 발급받은 후 반드시 기계번역 항목을 사용함으로 체크해야 사용할 수 있습니다."></i></th>
						<td>
							<input name="naver_client_id" type="text" value="<?php echo $options['naver_client_id'];?>" placeholder="네이버 API Client ID">
						</td>
					</tr>
					<tr class="file-translate-options naver-translate-options">
						<th width="80%">네이버 API - Client Secret <i class="fa fa-question-circle fa-c2x tooltips" title="<a href='https://developers.naver.com/register' target='_blank'>이곳</a>에서 신청하면 됩니다. <br>키를 발급받은 후 반드시 기계번역 항목을 사용함으로 체크해야 사용할 수 있습니다."></i></th>
						<td>
		...
		<div class="row">
			<div class="large-9 columns">
				<div class="panel callout radius">
					...
					<h4><i class="fa fa-coffee"></i> 제작: <a href="http://rocketpress.kr" target="_blank">Qwerty23</a></h4>
					<ol>
					...
					기타 플러그인에 관한 문의 및 건의사항은 <a href="//rocketpress.kr/forums/" target="_blank"><i class="fa fa-rocket"></i>Rocketpress 문의 게시판</a> 을 확인해 주세요.
				</div>
			</div>
